...
cookbook_file "#{node['nginx']['dir']}/sites-available/admin.exchange-expert.cf.conf" do
  source "admin.exchange-expert.cf.conf"
  owner "root"
  group "root"
  mode  "0644"
end
...
cookbook_file "#{node['nginx']['dir']}/sites-available/login.exchange-expert.cf.conf" do
  source "login.exchange-expert.cf.conf"
  owner "root"
  group "root"
  mode  "0644"
end
...
nginx_site "login.exchange-expert.cf.conf" do
  enable true
end
